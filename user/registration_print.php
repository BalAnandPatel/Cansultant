         ...
         <div class="invoice-header">
            <div class="invoice-from">
               ...
               <table>
                     ...
                     <tr><td><small>Examination Name: </small></td><td><small><?php echo ucfirst($result->records[0]->exam_name);?></small></td></tr>
                     <tr><td><small>Full Name: </td><td><small> <?php echo ucfirst($result->records[0]->full_name);?></small></td></tr>
                     <tr> <td><small>Registration Number: <small></td><td> <small><?php echo ucfirst($result->records[0]->registration_no);?><br></small></td></tr>
                     <tr> <td><small>Password: <small></td><td> <small><?php echo ucfirst($result->records[0]->password);?><br></small></td></tr>
                     <tr> <td><small>Date of Birth: <small></td> <td> <small> <?php echo $result->records[0]->dob;?></small> <br></td></tr>
