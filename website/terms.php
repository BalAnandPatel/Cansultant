                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-8 mb-5">
                            <div class="project-details__content-left">
                                ...
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                When you complete the registration process or sign up to our services, you agree to these Terms. These Terms may be updated from time to time. Your continued use of our services means that you accept any new or modified terms and conditions that we come up with. These Terms will always be available for users to read on this page.</p>
                                ...
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                In order to operate and provide the Service and the Mobile App, we may collect certain information about You, including technical and telemetry data related to your use of the Mobile App. We may use third party service providers to help us collect and analyse this data. The same shall not form breach of privacy.</p>
