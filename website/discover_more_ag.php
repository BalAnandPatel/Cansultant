                    ...
                    <div class="col-xl-12">
                        <div class="project-details__top">
                            <div class="project-details__img">
                                <img src="assets/images/project/image-3.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-8 mb-5">
                            <div class="project-details__content-left">
                                ...
                                To improve the condition of agriculture and farmers in utter pradesh through the Shailja Sameer Education and green revolution COPO PVT. LTD.
                                ...
                                <strong>[B] Green Manure :-</strong>
                                 <ul style="list-style-type:square;">
                                    <li>The construction work of green manure is a good means of mixing nicks in the soil. It is effective in increasing soil quality by adding green organic waste produced by plants and chops to the soil.</li>
                                    <li>Green Manure also balances nitrogen and humidity in the soil.</li>
                                </ul>
