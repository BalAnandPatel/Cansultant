                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-8">
                            <div class="project-details__content-left">
                                <h3 class="project-details__title-1">Harvest Innovations</h3>
                                ...
                                <h3 class="project-details__sub-title">Making this the first true generator on the
                                    Internet.</h3>
                                <p class="project-details__text-4">When an unknown printer took a galley of type and
                                ...
                                <p class="project-details__text-5">Beyond more stoic this along goodness hey this this
                                    wow manatee mongoose one as since a far flustered impressive manifest far crud
                                    opened inside owing punitively around forewent and after wasteful telling sprang
                                    coldly and spoke less clients. Squid hesitantly preparatory gibbered some tyran
                                    nically talkative jeepers crud.</p>
                            ...
                            <div class="project-details__content-right">
                                <div class="project-details__details-box">
                                    <div class="project-details__bg-shape"
                                        style="background-image: url(assets/images/shapes/project-details-shape-1.png);">
                                    </div>
                                ...
                                <div class="project-details__quote">
                                    <h3 class="project-details__quote-title">Get Free Quote</h3>
                                    <form action="https://layerdrops.com/agrionhtml/main-html/assets/inc/sendemail.php"
                                        ...
                                        <div class="project-details__btn-box">
                                            <a href="about.html" class="thm-btn project-details__btn">Send Message <i
